        ...
        <div className="grid grid-cols-2 gap-4">
          {data.hotspots.map((spot, i) => {
            ...
            return (
              <div
                key={i}
                className="aspect-square bg-white border border-slate-100 rounded-[32px] p-8 flex flex-col justify-between group hover:border-emerald-500 transition-all hover:shadow-xl hover:shadow-emerald-500/5"
              >
