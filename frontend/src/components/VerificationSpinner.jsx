...
import { Shield, ShieldCheck, Activity, Zap, Navigation } from "lucide-react";
        ...
        <div className={containerClasses}>
            ...
            <div className="relative flex items-center justify-center">
                ...
                {[0, 1, 2].map((i) => (
                    ...
                    >
                        <div className="w-1.5 h-1.5 bg-emerald-500/40 rounded-full" style={{ position: 'absolute', top: 0, left: '50%' }} />
                    </motion.div>
                ))}
            </div>
