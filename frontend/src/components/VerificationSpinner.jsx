  ...
  return (
    <div className={containerClasses}>
      ...
      <div className="text-center space-y-6 relative z-10 max-w-sm px-6">
        <div className="space-y-2">
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-[11px] font-bold uppercase tracking-[0.5em] text-slate-300"
          >
            {subtext}
          </motion.p>
      ...
      <div className="absolute bottom-12 flex flex-col items-center gap-4 opacity-20 pointer-events-none">
        <div className="flex items-center gap-4 font-bold text-[11px] uppercase tracking-widest text-slate-400">
          <Navigation size={14} /> SECURE_PROTOCOL // AUTHORIZATION_GRID_V.4
        </div>
        <div className="flex items-center gap-3">
          <div className="w-1.5 h-1.5 bg-emerald-500 rounded-full animate-pulse" />
          <span className="text-[11px] font-bold uppercase tracking-[0.4em] text-slate-300">
