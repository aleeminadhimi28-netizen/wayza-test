        ...
        <div className="flex flex-col gap-4 md:gap-6">
          ...
          <div className="px-0.5">
            <div className="flex justify-between items-start mb-1">
              <h3 className="text-base md:text-lg font-bold text-slate-900 group-hover:text-emerald-600 transition-colors tracking-tight truncate pr-2">
                {hotel.name}
              </h3>
              <div className="flex items-center gap-1 font-bold text-slate-900 text-xs md:text-sm shrink-0">
            ...
            <div className="flex justify-between items-center mb-2">
              <p className="text-slate-500 font-semibold text-xs truncate pr-2">{hotel.location}</p>
              {hotel.wifiSpeed > 0 && (
                <div className="flex items-center gap-1 px-2 py-0.5 bg-emerald-50 rounded-lg border border-emerald-100 shadow-sm shrink-0">
