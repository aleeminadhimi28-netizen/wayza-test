...
export default function Booking() {
  ...
  useEffect(() => {
    ...
    Promise.all([api.getListing(id), api.getBookedDates(id)])
  ...
  const discountAmount = discountInfo
    ? Math.round(baseAmount * discountInfo.discountPercentage)
    : 0;
                ...
                <AnimatePresence>
                  {blockedDates && (
                    <motion.div
                      ...
                      className="mt-8 p-4 bg-rose-50 text-rose-600 rounded-2xl border border-rose-100 text-sm font-medium flex items-center gap-3"
                    >
                      <Info size={18} />
                ...
                <div className="p-6 md:p-8 space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between text-slate-600 font-medium">
                        <span>
                          GST {isVehicle ? '(Waived for Vehicles)' : `(${gstRate * 100}%)`}
                        </span>
                        {isVehicle ? (
