...
function FloatingInput({ id, type = 'text', label, value, onChange, icon: Icon, suffix }) {
  ...
  return (
    <div className="su-field">
      <div className={`su-field-wrap ${active ? 'su-field-wrap--active' : ''} ${focused ? 'su-field-wrap--focused' : ''}`}>
...
export default function Signup() {
  ...
  const googleLogin = useGoogleLogin({
    ...
    onError: (err) => {
      showToast(err?.error_description || err?.error || 'Google Popup failed or was closed.', 'error');
    },
  });
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {loading && (
          <VerificationSpinner message="Initializing Identity..." subtext="Synchronizing Member Records" />
        )}
      </AnimatePresence>
      ...
      <div className="su-page">
        ...
        <div className="su-hero">
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            ...
            >
              Unlock curated clifftop sanctuaries, high-performance vehicles, and hidden Varkala secrets — all in one place.
            </motion.p>
            <motion.div
            ...
            >
              <div>
                <div className="su-stat-num">120<span>+</span></div>
                <div className="su-stat-label">Sanctuaries</div>
              </div>
              <div>
                <div className="su-stat-num">4.9<span>★</span></div>
                <div className="su-stat-label">Avg Rating</div>
              </div>
              <div>
                <div className="su-stat-num">2k<span>+</span></div>
        ...
        <main className="su-form-panel">
          ...
          >
            ...
            <Link to="/" className="su-brand">
              ...
              <span className="su-brand-name">WAYZZA<span>.</span></span>
            </Link>

            {/* Heading */}
            <div className="su-heading">
              <h1>Begin Your <span>Journey.</span></h1>
