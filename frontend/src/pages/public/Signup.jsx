            ...
            <main className="w-full lg:w-1/2 flex flex-col justify-center p-8 md:p-24 relative bg-white">
                <div className="max-w-md w-full mx-auto space-y-10">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-5xl md:text-6xl font-bold text-slate-900 tracking-tighter leading-none uppercase">Begin Your <span className="text-emerald-500 lowercase">Journey.</span></h2>
                        <p className="text-slate-400 font-bold text-[10px] uppercase tracking-[0.4em] border-l-2 border-emerald-500/20 pl-4">"Join the network to experience the ultimate luxury."</p>
                    </div>
                    ...
                    <form onSubmit={handleSignup} className="space-y-8 group">
                        ...
                        <div className="flex gap-4">
                            ...
                            <button
                                ...
                                className="w-full h-16 bg-slate-900 border border-slate-900 rounded-2xl flex items-center justify-center gap-3 hover:bg-slate-800 hover:-translate-y-0.5 transition-all shadow-sm"
                            >
                                <svg className="w-5 h-5" fill="white" viewBox="0 0 24 24"><path d="M16.636 12.022c-.015-2.585 2.128-3.834 2.227-3.896-1.2-1.748-3.078-1.986-3.754-2.016-1.597-.16-3.121.932-3.93.932-.81 0-2.072-.9-3.414-.876-1.748.026-3.364 1.012-4.256 2.55-1.815 3.123-.464 7.746 1.305 10.288.868 1.25 1.895 2.646 3.257 2.596 1.312-.05 1.815-.845 3.385-.845 1.57 0 2.022.845 3.414.82 1.415-.025 2.277-1.25 3.121-2.496 1.01-1.465 1.415-2.88 1.44-2.955-.025-.012-2.766-1.05-2.795-4.1zm-1.896-7.533c.732-.888 1.225-2.126 1.09-3.364-1.076.044-2.355.714-3.111 1.627-.674.81-1.275 2.074-1.115 3.284 1.2.093 2.404-.662 3.136-1.547z"/></svg>
