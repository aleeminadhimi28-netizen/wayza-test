        ...
        <div className="relative z-10 space-y-12">
          ...
          >
            ...
            <p className="text-slate-400 text-lg font-medium leading-relaxed">
              "Establish your new secure password. We recommend a unique combination of characters
                  ...
                  <div className="space-y-6">
                    <div className="space-y-3 group">
                      ...
                      <div className="relative">
                        <Lock
                          className="absolute left-6 top-1/2 -translate-y-1/2 text-slate-200 group-focus-within:text-emerald-600 transition-colors"
                          size={20}
                        />
                        <input
