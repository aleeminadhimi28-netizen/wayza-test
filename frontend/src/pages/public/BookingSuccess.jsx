        ...
        <div className="min-h-[70vh] flex flex-col items-center justify-center p-10 text-center space-y-10">
          ...
          <div className="space-y-4 max-w-sm">
            ...
            <p className="text-slate-400 font-medium">
              We couldn't find your active reservation data. Please check your bookings history.
            </p>
          </div>
          <Link
            to="/my-bookings"
            ...
            <div className="relative z-10 space-y-12">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-10">
                ...
                <div className="text-right">
                  ...
                  <span className="font-mono text-sm font-bold text-emerald-600 bg-emerald-50 px-5 py-2.5 rounded-2xl border border-emerald-100 uppercase tracking-tighter shadow-sm">
                    WZ-{bookingId?.slice(-12).toUpperCase()}
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 pt-10 border-t border-slate-100">
                <div className="space-y-3 bg-slate-50 p-6 rounded-3xl border border-slate-100">
                  ...
                  <p className="text-xl font-bold text-slate-900 tracking-tight uppercase leading-tight">
                    {title}
                  </p>
                </div>
                ...
                <div className="space-y-3 bg-slate-50 p-6 rounded-3xl border border-slate-100">
                  ...
                  <Link
                    to="/guest-chat"
                    className="inline-flex items-center gap-3 text-emerald-600 font-bold text-xs uppercase tracking-widest hover:translate-x-1 transition-transform"
                  >
