                        ...
                        {loading ? (
                            ...
                            <motion.div key="empty" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="py-40 text-center space-y-10 group bg-white rounded-[60px] border border-slate-200 shadow-sm px-10">
                                <div className="relative inline-block">
                                    ...
                                    <motion.div animate={{ scale: [1, 1.2, 1] }} transition={{ repeat: Infinity, duration: 2 }} className="absolute -top-2 -right-2 w-10 h-10 bg-emerald-500 rounded-full flex items-center justify-center text-white text-xs font-bold border-4 border-white">
                                        0
                                    </motion.div>
                                </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6 pb-40">
                        <div className="bg-slate-900 rounded-[60px] p-20 text-center relative overflow-hidden group shadow-2xl">
                            ...
                            <div className="relative z-10 space-y-10">
                                ...
                                <h3 className="text-4xl md:text-6xl font-bold text-white tracking-tight uppercase leading-none">Find More Masterpieces.</h3>
                                <p className="text-white/40 font-bold uppercase text-[10px] tracking-[0.4em]">Expand your horizons and add to your unique collection</p>
                                <Link to="/listings" className="h-20 px-16 bg-white text-slate-900 rounded-[28px] font-bold uppercase text-[10px] tracking-widest transition-all hover:bg-emerald-500 hover:text-white shadow-3xl inline-flex items-center gap-4 active:scale-95">
