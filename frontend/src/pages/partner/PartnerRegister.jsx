...
import { Hammer, Zap, ShieldCheck, Mail, Lock, Briefcase, Eye, EyeOff, ArrowRight, ArrowLeft, Activity, Globe, Sparkles, Building, Wallet, ChevronDown } from "lucide-react";
                ...
                <div className="relative z-10 space-y-12">
                    ...
                    <div className="flex gap-12 opacity-30 pointer-events-none">
                        <div className="flex flex-col items-center gap-3">
                            <Globe size={24} />
                            <span className="text-[9px] font-black uppercase tracking-[0.3em] text-center">Global Audience</span>
                        </div>
                        <div className="flex flex-col items-center gap-3">
                            <Zap size={24} className="text-emerald-400" />
                            <span className="text-[9px] font-black uppercase tracking-[0.3em] text-center">Direct Channel</span>
                        </div>
                        <div className="flex flex-col items-center gap-3">
                            <Activity size={24} />
                            <span className="text-[9px] font-black uppercase tracking-[0.3em] text-center">Verified Net</span>
                        </div>
                    </div>
                </div>
                    ...
                    >
                        <header className="space-y-8">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-[0.5em] text-emerald-600">Merchant Onboarding</span>
                            </div>
                        ...
                        <form onSubmit={submit} className="space-y-10">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-3 group/field">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] ml-2 group-focus-within/field:text-emerald-600 transition-colors">Legal Instance</label>
                                ...
                                <div className="space-y-3 group/field">
                                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] ml-2">Service Portfolio</label>
                                    <div className="relative">
                            ...
                            <div className="space-y-3 group/field">
                                <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.4em] ml-2 group-focus-within/field:text-emerald-600 transition-colors">Account Access Password</label>
                                <div className="relative">
                                    <div className="absolute left-6 top-1/2 -translate-y-1/2 w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center group-focus-within/field:bg-emerald-50 transition-colors">
