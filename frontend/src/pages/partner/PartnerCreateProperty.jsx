        ...
        navigator.geolocation.getCurrentPosition(
            async (position) => {
                ...
                try {
                    ...
                    setLocation(parts.join(", ") || data.display_name || `${lat.toFixed(4)}, ${lng.toFixed(4)}`);
            ...
            (error) => {
                setLocationLoading(false);
                if (error.code === 1) showToast("Location access denied. Please enable GPS permissions.", "error");
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Name, location, and category of your property.</p>
                            </div>

                            <div className="space-y-4">
                                <div className="space-y-2">
                                    <label className="text-xs font-semibold text-slate-700 block">Property Name <span className="text-rose-400">*</span></label>
                                ...
                                <div className="space-y-2">
                                    <label className="text-xs font-semibold text-slate-700 block">Property Location <span className="text-rose-400">*</span></label>
                                    ...
                                    {!locationLocked ? (
                                            ...
                                            >
                                                {locationLoading ? (
                                                    <>
                                                        ...
                                                        <span className="text-xs font-semibold text-emerald-700">Fetching GPS location...</span>
                                                    </>
                                                ) : (
                                                    <>
                                                        <Crosshair size={20} className="text-emerald-600 group-hover:scale-110 transition-transform" />
                                                        <span className="text-xs font-bold text-emerald-700">Use My GPS Location</span>
                                                        <span className="text-[10px] text-emerald-500">Auto-detect your exact property coordinates</span>
                                                    </>
                                                )}
                                            </button>
                                            <div className="relative flex items-center gap-3 my-1">
                                                <div className="flex-1 h-px bg-slate-200" />
                                                <span className="text-[10px] font-semibold text-slate-400 uppercase">or type manually</span>
                                                <div className="flex-1 h-px bg-slate-200" />
                                            </div>
                                            <div className="relative">
                                        ...
                                        <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 space-y-3">
                                            <div className="flex items-start justify-between gap-3">
                                                <div className="flex items-start gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-emerald-600 mt-0.5 font-mono">{latitude}, {longitude}</p>
                                                    </div>
                                                </div>
                                                <button
                                                    type="button"
                                            ...
                                            <p className="text-[11px] text-emerald-600 flex items-center gap-1.5">
                                                <Crosshair size={11} /> GPS coordinates locked — your property will appear on the map
                                            </p>
                                        </div>
                                    )}
                                </div>
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-sm text-slate-500">Upload a high-quality image for your property listing.</p>
                            </div>
                            ...
                            {!preview ? (
                                <div className="relative aspect-[4/3] bg-slate-50 border-2 border-dashed border-slate-200 rounded-2xl flex flex-col items-center justify-center cursor-pointer hover:border-emerald-400 hover:bg-emerald-50/30 transition-all group/upload">
                                    ...
                                    <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-md mb-3 group-hover/upload:scale-110 transition-transform">
                                        <UploadCloud className="text-slate-400 group-hover/upload:text-emerald-500 transition-colors" size={24} />
                                    </div>
                                ...
                                <div className="relative aspect-[4/3] overflow-hidden rounded-2xl shadow-lg border border-slate-200 group/preview">
                                    <img src={preview} alt="Preview" className="w-full h-full object-cover group-hover/preview:scale-105 transition-transform duration-500" />
                                    <button
                                        type="button"
                                        onClick={removeImage}
