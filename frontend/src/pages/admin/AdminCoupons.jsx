    ...
    >
      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 overflow-hidden">
        ...
        <form
          ...
          className="flex flex-col sm:flex-row gap-4 items-end bg-slate-50 p-4 rounded-xl border border-slate-100 mb-8"
        >
          ...
          <button
            type="submit"
            className="w-full sm:w-auto h-11 px-6 bg-slate-900 text-white rounded-xl font-semibold text-sm hover:bg-emerald-600 transition-colors flex items-center justify-center gap-2"
          >
        ...
        {coupons.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {coupons.map((c) => (
              <div
                key={c._id}
                className="relative bg-white border border-slate-200 rounded-2xl p-5 hover:border-emerald-200 transition-colors group"
              >
