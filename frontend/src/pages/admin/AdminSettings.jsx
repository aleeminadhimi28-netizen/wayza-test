...
export default function AdminSettings() {
  ...
  if (loading)
    return <div className="text-white p-12 text-center opacity-50">Loading engine state...</div>;
  if (!config) return <div className="text-rose-500 p-12 text-center">Failed to load config.</div>;

  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div>
        <h1 className="text-3xl font-black text-white uppercase tracking-tighter mb-2 border-l-4 border-emerald-500 pl-4">
          Platform Economics
        </h1>
