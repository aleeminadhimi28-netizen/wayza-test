                ...
                <div className="max-w-md w-full">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-sm mt-1">Enter your admin credentials to access the dashboard.</p>
                        </div>
                        ...
                        <div className="pt-4 text-center border-t border-slate-100">
                            <Link to="/login" className="inline-flex items-center gap-2 text-slate-500 text-sm font-medium hover:text-emerald-600 transition-colors">
