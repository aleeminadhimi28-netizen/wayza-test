import {
    Wifi, Wind, Zap, Shield, Droplets, Car,
    Mountain, Waves, Sun, Sparkles, GlassWater,
    Monitor, Network, Plug, Users,
    Utensils, Shirt, Home, Dog,
    Lock, PlusSquare, Flame, Bluetooth, Tv
} from "lucide-react";
